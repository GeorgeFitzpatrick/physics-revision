...
@PageTitle("Physics Revision")
@Route(value = "")
@Tag("physics-revision-view")
@JsModule("./views/physicsrevision/physics-revision-view.ts")
public class PhysicsRevisionView extends LitTemplate implements HasComponents, HasStyle {

    @Id
    private Select<String> sortBy;

    public PhysicsRevisionView() {
        addClassNames("physics-revision-view", "flex", "flex-col", "h-full");
